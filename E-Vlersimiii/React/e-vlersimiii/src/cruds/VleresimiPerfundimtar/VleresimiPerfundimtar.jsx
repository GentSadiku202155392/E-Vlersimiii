...
export default function VleresimiPerfundimtar () {
    ...
    useEffect(() => {
        axios.get( 'https://localhost:7138/api/VleresimiPerfundimtar/GetNotaP' )
            .then(response => {
 ...
 function DeleteVleresimiPerfundimtar(VlersimiPerfundimtar) {
    ...
    if (confirmBox === true) {
        axios.delete('https://localhost:7138/api/VleresimiPerfundimtar/FshijeVleresimiPerfundimtar/3' + VlersimiPerfundimtar.NotaP)
            .then(() => {
